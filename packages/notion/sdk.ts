// TODO(Frattezi): Since the notion-sdk don't export its types we need
// To recreate some interfaces here so we can extract return values from
// notion-client methods.
//
// Can be removed after the notion developers find a better way to export the package types.
